	...
	if (count($importTypeList)<1) {
		...
		foreach ($importTypeList as $importTypeName => $importType) {
			print "<tr>" ;
				...
				print "</td>";
				print "<td>";
					print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/import_setup.php&type=" . $importTypeName . "'><img title='" . __($guid, 'Run') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/run.png'/></a> " ;
				print "</td>";
			print "</tr>" ;
		}
		print "</table>" ;
